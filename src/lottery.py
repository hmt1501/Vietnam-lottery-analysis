...
class Lottery:
    ...
    def dump(self) -> None:
        frames.dump_frames(self._raw_data, self._2_digits_data, self._sparse_data, 'xsmb')
    ...
    def generate_dataframes(self) -> None:
        ...
        self._raw_data, self._2_digits_data, self._sparse_data = frames.build_frames(records)
